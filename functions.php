...
function hello_scripts() {
	wp_enqueue_style( 'hello-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'hello-style', 'rtl', 'replace' );

	wp_enqueue_script( 'hello-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );

	wp_enqueue_script( 'hello-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), _S_VERSION, true );
