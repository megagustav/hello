...
<hr>
	...
	<form class="form-inline mt-5" id="sib-form" method="POST" action="https://45aab95b.sibforms.com/serve/MUIEAJdNnzb53mFEumfecKzht9ALB81RkiJPL3rP3q6uuS1l-jMoznUFY_9XK1ow9k2z9exy8Ze9Gl0YVky2VNGT4iKfOmMo9qMIL5j7pSi0CqHEpLbWx2flcFPrH_G76DOLbiYKr62lGmbK8tA8dTshjTwMGcci7XaPi520go-1izJrTRJGpr2kYrLw2jdKxA50VQd45MsKjLJS"
	data-type="subscription">
		<label class="sr-only entry__label" for="EMAIL" data-required="*">E-Mail Adresse</label>
		<div class="input-group mb-2 mr-sm-2 col-sm-9 px-0">
			<div class="input-group-prepend">
			  <div class="input-group-text">@</div>
			</div>
			<input class="form-control input" type="text" id="EMAIL" name="EMAIL" autocomplete="off" placeholder="E-Mail Adresse" data-required="true" required />
		</div>
		...
		<label>
			...
			<span class="checkbox checkbox_tick_positive"></span><span style="font-size:14px; text-align:left; font-family:&quot;Helvetica&quot;, sans-serif; color:#3C4858; background-color:transparent;"><p>Ich möchte Ihren Newsletter erhalten und akzeptiere die Datenschutzerklärung.</p></span>
		</label>
		<label class="entry__error entry__error--primary" style="font-size:16px; text-align:left; font-family:&quot;Helvetica&quot;, sans-serif; color:#661d1d; background-color:#ffeded; border-radius:3px; border-color:#ff4949;">
		</label>
		<label class="entry__specification" style="font-size:12px; text-align:left; font-family:&quot;Helvetica&quot;, sans-serif; color:#8390A4;">
		...
		<button type="submit" form="sib-form" class="col-sm-2 px-0 btn btn-block btn-primary mb-2">
